...
public:
    ...
    , service_node_name_(service_node_name)
  {
    ...
    RCLCPP_DEBUG(
      node_->get_logger(), "Waiting for \"%s\" service", service_name_.c_str());
   ...
   */
  virtual BT::NodeStatus on_completion() { return BT::NodeStatus::SUCCESS; }
  ...
  virtual BT::NodeStatus check_future()
  {
    ...
    if (remaining > std::chrono::milliseconds(0)) {
      // auto timeout = remaining > bt_loop_duration_ ? bt_loop_duration_ :
      // remaining;
