  ...
  : costmap_(costmap)
{
  ...
  clear_except_service_ = node->create_service<ClearExceptRegion>(
    ...
    std::bind(&ClearCostmapService::clearExceptRegionCallback,
              this,
              std::placeholders::_1,
              std::placeholders::_2,
              std::placeholders::_3));
  ...
  clear_around_service_ = node->create_service<ClearAroundRobot>(
    ...
    std::bind(&ClearCostmapService::clearAroundRobotCallback,
              this,
              std::placeholders::_1,
              std::placeholders::_2,
              std::placeholders::_3));
  ...
  clear_entire_service_ = node->create_service<ClearEntirely>(
    ...
    std::bind(&ClearCostmapService::clearEntireCallback,
              this,
              std::placeholders::_1,
              std::placeholders::_2,
              std::placeholders::_3));
...
void
ClearCostmapService::clearExceptRegionCallback(
...
void
ClearCostmapService::clearAroundRobotCallback(
  const shared_ptr<rmw_request_id_t> /*request_header*/,
...
void
ClearCostmapService::clearEntireCallback(
...
void
ClearCostmapService::clearRegion(const double reset_distance, bool invert)
{
  double x, y;
...
void
ClearCostmapService::clearLayerRegion(shared_ptr<CostmapLayer>& costmap,
                                      double pose_x,
                                      double pose_y,
                                      ...
                                      bool invert)
{
  ...
  costmap->worldToMapEnforceBounds(
    start_point_x, start_point_y, start_x, start_y);
...
void
ClearCostmapService::clearEntirely()
{
...
bool
ClearCostmapService::getPosition(double& x, double& y) const
{
